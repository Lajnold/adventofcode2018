...
def part1():
    ...
    while sources:
        ...
        while source and source.y <= max_y:
            if source in clay or source in water:
                expander = source.up()
                source = None
            else:
                if source.y >= min_y:
